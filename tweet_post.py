...
consumer_key = keys['replace it consumer_key']
consumer_secret = keys['replace it consumer_secret']
access_token = keys['replace it access_token']
access_token_secret = keys['replace it access_token_secret']
